	...
	<div class="zzjgbox">
		...
		<ul class="abdtbox">
			...
			<li class="right">
				...
				<br>
				Chandan Prasad 教授：美国德州女子大学营养与食品科学系教授、《Current Topics in Nutraceutical Research》主编
				<div class="jx"></div>
			</li>
			<div class="clear"></div>
		</ul>
	...
	<div class="zzjgbox">
		<ul class="abdtbox">
			...
			<li class="right">
				...
				白卫滨教授：暨南大学理工学院副院长、食品安全与营养研究院常务副院长<br>
				毕  阳教授：甘肃农业大学副校长<br>
