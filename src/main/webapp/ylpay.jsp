...
<%
	...
	int ordermoney = 1;//Integer.parseInt(request.getParameter("ordermoney"))*100;
	...
	String testSecret = "6fbd6d99-0d52-48c6-87d4-8a618407cc4d";
	...
	BCOrder bcOrder = new BCOrder("UN_WAP".equals(qd)?PAY_CHANNEL.UN_WAP:PAY_CHANNEL.UN_WEB, ordermoney, orderno, "会议费银联支付订单");//设定订单信息
	...
	//bcOrder.setReturnUrl("http://localhost/scp_pay/payresult.jsp?ono="+orderno+"&rid="+registerid);//设置return url
	bcOrder.setOptional(optional);
	try {
	    bcOrder = BCPay.startBCPay(bcOrder);
	    //out.println(bcOrder.getObjectId());
	    out.println(bcOrder.getHtml()); // 输出银联支付信息到页面
	} catch (BCException e) {
